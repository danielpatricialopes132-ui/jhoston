...
export default function Sidebar() {
  ...
  const icons = {
    ...
    contasBancarias: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/><path d="M6 15h2v.01"/></svg>
    ),
    produtosServicos: (
  ...
  const menuItems = [
    ...
    { name: "Contas Bancárias", path: "/contas-bancarias", icon: icons.contasBancarias, adminOnly: true, masterOnly: false },
    { name: "Cad. Fornecedores", path: "/fornecedores", icon: icons.fornecedores, adminOnly: true, masterOnly: false },
    { name: "Cad. Prod/Serviços", path: "/produtos-servicos", icon: icons.produtosServicos, adminOnly: true, masterOnly: false },
